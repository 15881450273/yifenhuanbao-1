...
<body>
<div class="x-body">
    <form class="layui-form"  method="post" action="/GarbageServlet?method=addgarbage">
        ...
        <%--<div class="layui-form-item">--%>
            ...
            <%--</label>--%>
            <%--<div class="layui-input-inline">--%>
                <%--<input type="file" id="pic" name="gpic" required lay-verify="required"--%>
                       <%--autocomplete="off" class="layui-input">--%>
            <%--</div>--%>
        <%--</div>--%>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" id="gdesc" name="gdesc" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="gname" class="layui-form-label">
